...
DESIGN=top.v
VERILOG_SOURCES = top.v debounce.v fsm_control.v cronometro.v control_display.v uart_tx.v uart_time_tx.v bcdto7seg.v bin_to_bcd_2digit.v mux_5digit.v servo_pwm.v
